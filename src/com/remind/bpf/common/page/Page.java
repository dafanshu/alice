package com.remind.bpf.common.page;
...
//			sb.append("	<li >第"+currentPage+"页</li>\n");
			sb.append("	<li class=\"active\"><a href=\"#\">共"+totalPage+"页/"+totalResult+"条记录</a></li>\n");
//			sb.append("	<li ><input type=\"text\" name=\"page.currentPage\"/><input type=\"button\" name=\"GO\"/></li>\n");
			sb.append("</ul>\n");
			sb.append("</div>");
